...
class DraggableImageOverlayView @JvmOverloads constructor(
    ...
    // ── Public callbacks ──────────────────────────────────────────────────────
    var onImageCommitted: ((uri: Uri, relativeX: Float, relativeY: Float, relativeWidth: Float, relativeHeight: Float, rotationAngle: Float, opacity: Float, isMirrored: Boolean, maskConfig: com.getwinharris.bapxcut.models.EditOperation.MaskConfig) -> Unit)? = null
    var onPositionChanged: ((relativeX: Float, relativeY: Float) -> Unit)? = null
    var onMaskChanged: ((com.getwinharris.bapxcut.models.EditOperation.MaskConfig) -> Unit)? = null
    ...
    var maskConfig = com.getwinharris.bapxcut.models.EditOperation.MaskConfig()
    ...
    fun activate(uri: Uri, aspect: Float = 1.0f) {
        ...
        maskConfig = com.getwinharris.bapxcut.models.EditOperation.MaskConfig()
        post {
            updateImageViewSizeAndPosition()
        }
    }

    fun activateForEdit(op: com.getwinharris.bapxcut.models.EditOperation.AddImageOverlay) {
        isEditingActive = true
    ...
    override fun dispatchDraw(canvas: Canvas) {
        val hasMask = maskConfig.shape != com.getwinharris.bapxcut.models.EditOperation.MaskShape.NONE
        if (hasMask && isEditingActive && imageUri != null) {
            ...
            when (maskConfig.shape) {
                com.getwinharris.bapxcut.models.EditOperation.MaskShape.RECTANGLE -> {
                    path.addRect(cx - mw/2, cy - mh/2, cx + mw/2, cy + mh/2, android.graphics.Path.Direction.CW)
                }
                com.getwinharris.bapxcut.models.EditOperation.MaskShape.ELLIPSE -> {
                    path.addOval(cx - mw/2, cy - mh/2, cx + mw/2, cy + mh/2, android.graphics.Path.Direction.CW)
                }
                com.getwinharris.bapxcut.models.EditOperation.MaskShape.SPLIT -> {
                ...
                com.getwinharris.bapxcut.models.EditOperation.MaskShape.SHUTTER -> {
                ...
                com.getwinharris.bapxcut.models.EditOperation.MaskShape.HEART -> {
                    createHeartPath(path, cx, cy, mw, mh)
                }
                com.getwinharris.bapxcut.models.EditOperation.MaskShape.STAR -> {
